...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            if (UserType == 4 || UserType == 21) { //Initiator-1, Initiator-2
                                                if (item.ApprovalStatus != 'PENDING') {
                                                    ...
                                                    cbList = '<div class="form-check custom-checkbox cbSelected"><input type="checkbox" onchange="GetSelectedValues(' + "'" + item.Req_No + "'" + ',' + iRowNum + ');" class="form-check-input" id="cblist' + iRowNum + '"></div>';
                                                }
                                            }
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            if (UserType == 4 || UserType == 21) { //Initiator-1, Initiator-2
                                                if (item.ApprovalStatus != 'PENDING') {
                                                    ...
                                                    cbList = '<div class="form-check custom-checkbox cbSelected"><input type="checkbox" onchange="GetSelectedValues(' + "'" + item.PO_NO + "'" + ',' + iRowNum + ');" class="form-check-input" id="cblist' + iRowNum + '"></div>';
                                                }
                                            }
                                            else if (UserType == 2 || UserType == 3) { //Authorizer-1, Authorizer-2
                                            ...
                                            lst = lst + '<tr><td>' + cbList + '</td><td style=' + rowStyle + '>' + iRowNum + '</td><td style=' + rowStyle + '>' + item.PO_WS + '</td><td style=' + rowStyle + '>' + item.PO_NO + '</td><td style=' + rowStyle + '>' + item.Date + '</td><td style=' + rowStyle + '>' + item.Item + '</td><td style=' + rowStyle + '>' + formatNumberWithCommas(item.Qty) + '</td><td style=' + rowStyle + '>' + formatNumberWithCommas(item.Amount) + '</td><td style=' + rowStyle + '><span id=' + item.StatusId + ' class="status">' + item.ApprovalStatus + '</span></td><td style=' + rowStyle + '>' + actionLink + '</td></tr>';
                                        });
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            if (UserType == 4 || UserType == 21) { //Initiator-1, Initiator-2
                                                if (item.ApprovalStatus != 'PENDING') {
                                                    ...
                                                    cbList = '<div class="form-check custom-checkbox cbSelected"><input type="checkbox" onchange="GetSelectedValues(' + "'" + item.GRN_NO + "'" + ',' + iRowNum + ');" class="form-check-input" id="cblist' + iRowNum + '"></div>';
                                                }
                                            }
                                            else if (UserType == 2 || UserType == 3) { //Authorizer-1, Authorizer-2
                                                if (item.StatusId == 2 || item.StatusId == 4) {
                                            ...
                                            actionLink = '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetDetailsByRequestId(' + "'" + item.GRN_NO + "'" + ')" title="View Report"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.1614 12.0531C15.1614 13.7991 13.7454 15.2141 11.9994 15.2141C10.2534 15.2141 8.83838 13.7991 8.83838 12.0531C8.83838 10.3061 10.2534 8.89111 11.9994 8.89111C13.7454 8.89111 15.1614 10.3061 15.1614 12.0531Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path fill-rule="evenodd" clip-rule="evenodd" d="M11.998 19.3549C15.806 19.3549 19.289 16.6169 21.25 12.0529C19.289 7.48892 15.806 4.75092 11.998 4.75092H12.002C8.194 4.75092 4.711 7.48892 2.75 12.0529C4.711 16.6169 8.194 19.3549 12.002 19.3549H11.998Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>'
                                                + '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetReasonsByRequestId(' + "'" + item.GRN_NO + "'" + ')" data-bs-toggle="modal" data-bs-target="#DetailModal" title="Reason"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.334 2.75012H7.665C4.644 2.75012 2.75 4.88912 2.75 7.91612V16.0841C2.75 19.1111 4.634 21.2501 7.665 21.2501H16.333C19.364 21.2501 21.25 19.1111 21.25 16.0841V7.91612C21.25 4.88912 19.364 2.75012 16.334 2.75012Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M15.9393 12.013H15.9483" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M11.9301 12.013H11.9391" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M7.92128 12.013H7.93028" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>';
                                            lst = lst + '<tr><td>' + cbList + '</td><td style=' + rowStyle + '>' + iRowNum + '</td><td style=' + rowStyle + '>' + item.GRN_WS + '</td><td style=' + rowStyle + '>' + item.GRN_NO + '</td><td style=' + rowStyle + '>' + item.Date + '</td><td style=' + rowStyle + '>' + item.Item + '</td><td style=' + rowStyle + '>' + formatNumberWithCommas(item.Qty) + '</td><td style=' + rowStyle + '><span id=' + item.StatusId + ' class="status">' + item.ApprovalStatus + '</span></td><td style=' + rowStyle + '>' + actionLink + '</td></tr>';
                                        });
                                ...
                                if (Success) {
                                    ...
                                    if (DataList != null) {
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            actionLink = '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetDetailsByRequestId(' + "'" + item.Req_No + "'" + ')" title="View Report"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.1614 12.0531C15.1614 13.7991 13.7454 15.2141 11.9994 15.2141C10.2534 15.2141 8.83838 13.7991 8.83838 12.0531C8.83838 10.3061 10.2534 8.89111 11.9994 8.89111C13.7454 8.89111 15.1614 10.3061 15.1614 12.0531Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path fill-rule="evenodd" clip-rule="evenodd" d="M11.998 19.3549C15.806 19.3549 19.289 16.6169 21.25 12.0529C19.289 7.48892 15.806 4.75092 11.998 4.75092H12.002C8.194 4.75092 4.711 7.48892 2.75 12.0529C4.711 16.6169 8.194 19.3549 12.002 19.3549H11.998Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>'
                                                + '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetReasonsByRequestId(' + "'" + item.Req_No + "'" + ')" data-bs-toggle="modal" data-bs-target="#DetailModal" title="Reason"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.334 2.75012H7.665C4.644 2.75012 2.75 4.88912 2.75 7.91612V16.0841C2.75 19.1111 4.634 21.2501 7.665 21.2501H16.333C19.364 21.2501 21.25 19.1111 21.25 16.0841V7.91612C21.25 4.88912 19.364 2.75012 16.334 2.75012Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M15.9393 12.013H15.9483" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M11.9301 12.013H11.9391" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M7.92128 12.013H7.93028" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>';
                                            lst = lst + '<tr><td>' + cbList + '</td><td style=' + rowStyle + '>' + iRowNum + '</td><td style=' + rowStyle + '>' + item.INPUT_WS + '</td><td style=' + rowStyle + '>' + item.Req_No + '</td><td style=' + rowStyle + '>' + item.Date + '</td><td style=' + rowStyle + '>' + item.Item + '</td><td style=' + rowStyle + '>' + formatNumberWithCommas(item.Qty) + '</td><td style=' + rowStyle + '><span id=' + item.StatusId + ' class="status">' + item.ApprovalStatus + '</span></td><td style=' + rowStyle + '>' + actionLink + '</td></tr>';
                                        });
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            if (UserType == 4 || UserType == 21) { //Initiator-1, Initiator-2
                                                if (item.ApprovalStatus != 'PENDING') {
                                                    ...
                                                    cbList = '<div class="form-check custom-checkbox cbSelected"><input type="checkbox" onchange="GetSelectedValues(' + "'" + item.Payment_Voucher + "'" + ',' + iRowNum + ');" class="form-check-input" id="cblist' + iRowNum + '"></div>';
                                                }
                                            }
                                            else if (UserType == 2 || UserType == 3) { //Authorizer-1, Authorizer-2
                                            ...
                                            actionLink = '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetDetailsByRequestId(' + "'" + item.Payment_Voucher + "'" + ')" title="View Report"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.1614 12.0531C15.1614 13.7991 13.7454 15.2141 11.9994 15.2141C10.2534 15.2141 8.83838 13.7991 8.83838 12.0531C8.83838 10.3061 10.2534 8.89111 11.9994 8.89111C13.7454 8.89111 15.1614 10.3061 15.1614 12.0531Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path fill-rule="evenodd" clip-rule="evenodd" d="M11.998 19.3549C15.806 19.3549 19.289 16.6169 21.25 12.0529C19.289 7.48892 15.806 4.75092 11.998 4.75092H12.002C8.194 4.75092 4.711 7.48892 2.75 12.0529C4.711 16.6169 8.194 19.3549 12.002 19.3549H11.998Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>'
                                                + '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetReasonsByRequestId(' + "'" + item.Payment_Voucher + "'" + ')" data-bs-toggle="modal" data-bs-target="#DetailModal" title="Reason"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.334 2.75012H7.665C4.644 2.75012 2.75 4.88912 2.75 7.91612V16.0841C2.75 19.1111 4.634 21.2501 7.665 21.2501H16.333C19.364 21.2501 21.25 19.1111 21.25 16.0841V7.91612C21.25 4.88912 19.364 2.75012 16.334 2.75012Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M15.9393 12.013H15.9483" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M11.9301 12.013H11.9391" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M7.92128 12.013H7.93028" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>';
                                            lst = lst + '<tr><td>' + cbList + '</td><td style=' + rowStyle + '>' + iRowNum + '</td><td style=' + rowStyle + '>' + item.PV_WS + '</td><td style=' + rowStyle + '>' + item.Payment_Voucher + '</td><td style=' + rowStyle + '>' + item.Date + '</td><td style=' + rowStyle + '>' + item.Type + '</td><td style=' + rowStyle + '>' + formatNumberWithCommas(item.Amount) + '</td><td style=' + rowStyle + '><span id=' + item.StatusId + ' class="status">' + item.ApprovalStatus + '</span></td><td style=' + rowStyle + '>' + actionLink + '</td></tr>';
                                        });
                                ...
                                if (Success) {
                                    ...
                                    if (DataList != null) {
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            actionLink = '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetDetailsByRequestId(' + "'" + item.Payment_Voucher + "'" + ')" title="View Report"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.1614 12.0531C15.1614 13.7991 13.7454 15.2141 11.9994 15.2141C10.2534 15.2141 8.83838 13.7991 8.83838 12.0531C8.83838 10.3061 10.2534 8.89111 11.9994 8.89111C13.7454 8.89111 15.1614 10.3061 15.1614 12.0531Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path fill-rule="evenodd" clip-rule="evenodd" d="M11.998 19.3549C15.806 19.3549 19.289 16.6169 21.25 12.0529C19.289 7.48892 15.806 4.75092 11.998 4.75092H12.002C8.194 4.75092 4.711 7.48892 2.75 12.0529C4.711 16.6169 8.194 19.3549 12.002 19.3549H11.998Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>'
                                                + '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetReasonsByRequestId(' + "'" + item.Payment_Voucher + "'" + ')" data-bs-toggle="modal" data-bs-target="#DetailModal" title="Reason"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.334 2.75012H7.665C4.644 2.75012 2.75 4.88912 2.75 7.91612V16.0841C2.75 19.1111 4.634 21.2501 7.665 21.2501H16.333C19.364 21.2501 21.25 19.1111 21.25 16.0841V7.91612C21.25 4.88912 19.364 2.75012 16.334 2.75012Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M15.9393 12.013H15.9483" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M11.9301 12.013H11.9391" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M7.92128 12.013H7.93028" stroke="#130F26" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg> </button>'
                                                + '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetPVSummaryByRequestId(' + "'" + item.Payment_Voucher + "'" + ')"  title="PV Summary"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M14.7379 2.76181H8.08493C6.00493 2.75381 4.29993 4.41181 4.25093 6.49081V17.2038C4.20493 19.3168 5.87993 21.0678 7.99293 21.1148C8.02393 21.1148 8.05393 21.1158 8.08493 21.1148H16.0739C18.1679 21.0298 19.8179 19.2998 19.8029 17.2038V8.03781L14.7379 2.76181Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M14.4751 2.75V5.659C14.4751 7.079 15.6231 8.23 17.0431 8.234H19.7981" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M14.2882 15.3585H8.88818" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.2432 11.606H8.88721" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> </button>'
                                                + '<button type = "button" class="btn btn-sm text-purple content-icon" onclick="GetPVInvoiceByRequestId(' + "'" + item.Payment_Voucher + "'" + ')" data-bs-toggle="modal" data-bs-target="#DetailModal" title="PV Invoice"> <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.4925 2.789H7.75349C4.67849 2.789 2.75049 4.966 2.75049 8.048V16.362C2.75049 19.444 4.66949 21.621 7.75349 21.621H16.5775C19.6625 21.621 21.5815 19.444 21.5815 16.362V12.334" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path fill-rule="evenodd" clip-rule="evenodd" d="M8.82812 10.9209L16.3011 3.44793C17.2321 2.51793 18.7411 2.51793 19.6721 3.44793L20.8891 4.66493C21.8201 5.59593 21.8201 7.10593 20.8891 8.03593L13.3801 15.5449C12.9731 15.9519 12.4211 16.1809 11.8451 16.1809H8.09912L8.19312 12.4009C8.20712 11.8449 8.43412 11.3149 8.82812 10.9209Z" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15.1655 4.60254L19.7315 9.16854" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg> </button>';
                                            lst = lst + '<tr><td>' + cbList + '</td><td style=' + rowStyle + '>' + iRowNum + '</td><td style=' + rowStyle + '>' + item.PV_WS + '</td><td style=' + rowStyle + '>' + item.Payment_Voucher + '</td><td style=' + rowStyle + '>' + item.Date + '</td><td style=' + rowStyle + '>' + item.PV_LOIM + '</td><td style=' + rowStyle + '>' + formatNumberWithCommas(item.Amount) + '</td><td style=' + rowStyle + '><span id=' + item.StatusId + ' class="status">' + item.ApprovalStatus + '</span></td><td style=' + rowStyle + '>' + actionLink + '</td></tr>';
                                        });
                                        ...
                                        $(DataList).each(function (i, item) {
                                            ...
                                            if (UserType == 4 || UserType == 21) { //Staff/Initiator
                                                if ((item.ApprovalStatus != 'PENDING') && (item.StatusId != 8)) {
                                                    cbList = '<div class="form-check custom-checkbox cbSelected"><input type="checkbox" checked disabled onchange="GetSelectedValues(' + "'" + item.RefNo + "'" + ',' + iRowNum + ');" class="form-check-input" id="cblist' + iRowNum + '"></div>';
                                                }
                                                else {
                                                    cbList = '<div class="form-check custom-checkbox cbSelected"><input type="checkbox" onchange="GetSelectedValues(' + "'" + item.RefNo + "'" + ',' + iRowNum + ');" class="form-check-input" id="cblist' + iRowNum + '"></div>';
                                                }
                                            }
        ...
        function GetPVSummaryByRequestId(Req_No) {
            window.open("Details.aspx?Req_No=" + Req_No + "&SecreenId=" + 1, '_blank');
        }
        ...
        window.onload = GetProjectType;tusId + ' class="status">' + s.ApprovalStatus + "</span></td><td style=" + d + ">" + o + "</td></tr>" })), $("#tblListPAF tbody").append(t), $("#tblListPAF tbody tr").each((function () { var e = $(this).find("span.status"), t = $(this).find("span").attr("id"), s = $(this).find("div.form-check"); "0" === t ? (e.addClass("badge badge-warning"), s.addClass("checkbox-warning")) : "4" === t || "7" === t ? (e.addClass("badge badge-success"), s.addClass("checkbox-success")) : "5" === t || "8" === t ? (e.addClass("badge badge-danger"), s.addClass("checkbox-danger")) : "2" === t ? (e.addClass("badge light badge-success"), s.addClass("checkbox-success")) : "3" === t || "6" === t ? (e.addClass("badge light badge-danger"), s.addClass("checkbox-danger")) : "1" === t && (e.addClass("badge light badge-info"), s.addClass("checkbox-info")) })), $("#tblListPAF").DataTable({ dom: "ZBfrltip", pageLength: 10, select: !0, lengthChange: !0, language: { paginate: { next: '<i class="fa-solid fa-angle-right"></i>', previous: '<i class="fa-solid fa-angle-left"></i>' } } })) } else $("#PAF").hide(), sweetAlert("Oops...", "No Record Found", "info") } }) } function formatNumberWithCommas(e) { return new Intl.NumberFormat("en-US").format(e) } function ClearContent() { $("#StartDate").val('<%= DateTime.Today.AddDays(-30).ToString("yyyy-MM-dd") %>'), $("#EndDate").val('<%= DateTime.Today.ToString("yyyy-MM-dd") %>'), $("#ddlProjects").val(1e3), $("#ddlStatus").val(-1), $("#WIMSAdmin_Request").hide(), $("#WIMSAdmin_PO").hide(), $("#WIMSAdmin_GRN").hide(), $("#WIMSAdmin_TakeIn").hide(), $("#WIMSAdmin_PV").hide(), $("#PAF").hide(), $("#btnStatus").hide(), $("input[name='rbReasons']:checked").val(0), GetContentList(-1), SelectedList = [] } function GetDetailsByRequestId(e) { window.open("Details.aspx?Req_No=" + e + "&SecreenId=" + QueryString_Mode, "_blank") } function GetPVSummaryByRequestId(e) { window.open("Details.aspx?Req_No=" + e + "&SecreenId=1", "_blank") } function GetTakeInByPO(e) { window.open("Details.aspx?Req_No=" + e + "&SecreenId=0", "_blank") } function GetSelectedValues(e, t) { if ($("#cblist" + t).is(":checked")) SelectedList += "," + e; else for (var s = s || ",", d = SelectedList.split(s), o = 0; o < d.length; o++)d[o] == e && (d.splice(o, 1), SelectedList = d.join(s)); SelectedList.length > 0 ? $("#btnStatus").show() : $("#btnStatus").hide() } function UpdateStatus(e) { "Approve" == e ? $.ajax({ type: "POST", contentType: "application/json; charset=utf-8", url: "api/approval/UpdateStatus?Status=" + e, data: PostDataJson(e), dataType: "json", success: function (t) { t.Success ? ("Approve" == e ? sweetAlert(" ", "Status approved", "success") : sweetAlert(" ", "Status rejected", "success"), ClearContent()) : sweetAlert(" ", "Failed to access database", "error"), SelectedList = [], GetContentList(-1) } }) : "Reject" == e ? $("#RejectedReasonModel").modal("show") : (e = "Reject", "" == $("#txtReason").val() ? sweetAlert(" ", "Please enter remarks", "error") : $.ajax({ type: "POST", contentType: "application/json; charset=utf-8", url: "api/approval/UpdateStatus?Status=" + e, data: PostDataJson(e), dataType: "json", success: function (t) { t.Success ? ("Approve" == e ? sweetAlert(" ", "Status approved", "success") : sweetAlert(" ", "Status rejected", "success"), $("#txtReason").val(""), $("#RejectedReasonModel").modal("hide")) : sweetAlert(" ", "Failed to access database", "error"), SelectedList = [], GetContentList(-1) } })) } function PostDataJson(e) { if ("Approve" == e) return JSON.stringify({ WIMS_PROJECT_ID: $("#ddlProjects").val(), FLOWDETAILID: QueryString_Mode, STATUS: e, REQNO: SelectedList }); $("input[name='rbReasons']:checked").val(); return JSON.stringify({ WIMS_PROJECT_ID: $("#ddlProjects").val(), FLOWDETAILID: QueryString_Mode, STATUS: e, REQNO: SelectedList, REASON: $("#txtReason").val() }) } function GetReasonsByRequestId(e) { $.ajax({ type: "GET", contentType: "application/json; charset=utf-8", url: "api/projects/GetReasonByRequestId?ReqNo=" + e, dataType: "json", success: function (e) { let t = e.Success, s = (e.Response, e.Data); if (t) { let t = "", d = "", o = 0; e = []; $("#tblReasons tbody").html(""), null != s ? $(s).each((function (e, s) { o += 1, d = "'text-align:center;'", t = t + "<tr><td style=" + d + ">" + s.USERTYPE + "</td><td style=" + d + ">" + s.STATUS + "</td><td style=" + d + ">" + s.REMARKS + "</td></tr>" })) : t += '<tr><td colspan="10" style="color:red;text-align:center;">No Record Found</td></tr>', $("#tblReasons tbody").html(t) } } }) } function GetImagesRequestId(e) { $.ajax({ type: "GET", contentType: !1, url: "api/projects/GetImagesByRequestId?PaymentApprovalId=" + e, dataType: "json", success: function (e) { let t = e.Success, s = (e.Response, e.Data); t && null != s && ($(s).each((function (e, t) { $("#img1").attr("src", "https://ecs.daewoo.net.pk/uploads/" + t.Image1), $("#img2").attr("src", "https://ecs.daewoo.net.pk/uploads/" + t.Image2), $("#img3").attr("src", "https://ecs.daewoo.net.pk/uploads/" + t.Image3) })), $("#AttachementModel").modal("show")) } }) } window.onload = GetProjectType;
    </script>
